...
Moving forward with the four models previously identfied, we will train them on our data and evaluate their performance using a series of tests to assess randomness, normality and independnce.
...
Both Model 2 and Model 4 passed all tests. However, we went with Model since it had a higher p-value under the Shapiro Test and due to its lower AIC score.


\subsection{Forecasting}

To forecast future observations, we use the forecast and predict functions to forecast our Model 2 using our held out data from 2019 and 2020 at the 95% confidence level. We first plot our model forecasts with the historical data. The black line shows the historical data and the blue red shows the forecast made by our model. 

TODO: Write about residuals
...
\begin{figure}
\includegraphics[width = .4\linewidth]{plots/sectors.png}
\end{figure}
