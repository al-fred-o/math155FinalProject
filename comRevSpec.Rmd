...
plot_months(totalRev2, main = "Commercial Revenue (2008-2019)", ylab = "Revenue (Millions)", xlab = "Year")
...
model2 = arima(recRev, order = c(0,1,1), seasonal = list(order=c(1,1,1),period= 12))
