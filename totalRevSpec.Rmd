...
model2 = arima(recRev, order = c(0,1,2), seasonal = list(order=c(0,1,1),period= 12))
...
#lines(recRev, pch = 3)
plot(fitted(model4), col = 'green', main = "Plotting Log Revenue With Model 4", ylab = "Log Revenue")
lines(recRev, pch = 3)
